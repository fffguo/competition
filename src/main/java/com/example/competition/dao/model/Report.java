...
public class Report {
    ...
    public void setMainStudentNo(String mainStudentNo) {
        this.mainStudentNo = mainStudentNo == null ? null : mainStudentNo.trim();
    }
    ...
    public void setMainStudentName(String mainStudentName) {
        this.mainStudentName = mainStudentName == null ? null : mainStudentName.trim();
    }
    ...
    public void setMainStudentSpecialty(String mainStudentSpecialty) {
        this.mainStudentSpecialty = mainStudentSpecialty == null ? null : mainStudentSpecialty.trim();
    }
    ...
    public void setMainStudentPhone(String mainStudentPhone) {
        this.mainStudentPhone = mainStudentPhone == null ? null : mainStudentPhone.trim();
    }
    ...
    public void setMainStudentEmail(String mainStudentEmail) {
        this.mainStudentEmail = mainStudentEmail == null ? null : mainStudentEmail.trim();
    }
    ...
    public void setMainStudentDepartment(String mainStudentDepartment) {
        this.mainStudentDepartment = mainStudentDepartment == null ? null : mainStudentDepartment.trim();
    }
    ...
    public void setMainStudentGrade(String mainStudentGrade) {
        this.mainStudentGrade = mainStudentGrade == null ? null : mainStudentGrade.trim();
    }
    ...
    public void setWorksNo(String worksNo) {
        this.worksNo = worksNo == null ? null : worksNo.trim();
    }
